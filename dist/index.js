    ...
    function AES() {
        ...
        this.decrypt = function (message, key, options) {
            ...
            if (options && options.iv) {
                ...
                var dataBitArray = browserify_sjcl_1.default.codec.base64.toBits(message);
                iv = browserify_sjcl_1.default.codec.base64.fromBits(dataBitArray.slice(0, 3));
                ct = browserify_sjcl_1.default.codec.base64.fromBits(dataBitArray.slice(3));
            }
            var decryptParams = {
                mode: 'gcm',
                ts: 128,
            ...
            var plainText = browserify_sjcl_1.default.decrypt(browserify_sjcl_1.default.codec.utf8String.toBits(key), JSON.stringify(decryptParams));
